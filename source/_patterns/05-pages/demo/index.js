...
export function enable(context = $(document), settings) {
  ...
  $('.homepage__text', context).html('the header color should be overwritten by settings in pl/index.js. this textbox was overwritten from js in 05-pages/demo/index.js.');
}
